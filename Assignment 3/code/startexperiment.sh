...
#	lamb=0.1
#	echo "----------------    SARSA \$lamb $n    ------------------"
#	python3 ./server/server.py -port $((4000+$n)) -i 1 -rs $n -ne 1600 -q | tee "results/sarsa_accum_lambda""$lamb""_rs$n.txt" &
#	sleep 1
...
#	lamb=0.25
#	echo "----------------    SARSA \$lamb $n    ------------------"
#	python3 ./server/server.py -port $((5000+$n)) -i 1 -rs $n -ne 1600 -q | tee "results/sarsa_accum_lambda""$lamb""_rs$n.txt" &
#	sleep 1
