...
parser.add_argument('-port', '--port', dest='port', type=int,
                    default=5000, help='Port for connection')
...
parser.add_argument('-lambda', '--lambda', dest='lamb', type=float,
                    default=0, help='Value of lambda')
parser.add_argument('-trace', '--trace', dest='trace', type=str, default='accum',
                    help='Value of trace {accum, replace}')
parser.add_argument('-rs', '--randomseed', dest='randomseed', type=int,
                    default=0, help='Seed for RNG.')
